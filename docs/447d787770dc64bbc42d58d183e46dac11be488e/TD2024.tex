...
\section{Satunnaisilmiöiden tilastollinen mallintaminen}\label{alaluku43}}
...
\caption{Taloustutkimuksen Ylelle teettämän eduskuntavaalien kannatustutkimukseen vastanneiden valitsemien puolueiden osuus vastanneista.}\label{fig:kannatusmittaus}
\end{figure}
...
\section{Tilastolliset tunnusluvut ja estimaattorit: esimerkkinä normaalijakauma}\label{alaluku44}}
...
Parametrien \(\mu\) ja \(\sigma^2\) arvoja ei tunneta ja tavoitteena onkin päätellä, \textbf{estimoida}, niiden arvot lopulta käytettävissä olevasta aineistosta.
...
\tightlist
\item
  Normaalisti jakautuneiden havaintojen (satunnaismuuttujien) \(Y_1, \ldots, Y_n\) \textbf{otoskeskiarvo} on
\end{itemize}
...
\hypertarget{luku7}{%
\section{Tilastolliset mallit ja jakaumat}\label{luku7}}
...
\hypertarget{satunnaisuudesta-johtuvan-epuxe4varmuuden-arvioiminen}{%
\chapter{Satunnaisuudesta johtuvan epävarmuuden arvioiminen}\label{satunnaisuudesta-johtuvan-epuxe4varmuuden-arvioiminen}}
...
\hypertarget{luvun-9-yhteenveto-keskeisiuxe4-termejuxe4-ja-kokonaisuuksia.-1}{%
\section{Luvun 9 yhteenveto, keskeisiä termejä ja kokonaisuuksia.}\label{luvun-9-yhteenveto-keskeisiuxe4-termejuxe4-ja-kokonaisuuksia.-1}}
