...
\item
  ...
  \end{itemize}
\item
  Käytännössä suurimman uskottavuuden estimointi perustuu juuri valitun tilastollisen mallin määrittelevälle tiheysfunktiolle tai pistetodennäköisyysfunktiolle kun aineisto on havaittu.
...
\begin{eblock}{}
Esimerkki: Normaalisti jakautuneen aineiston odotusarvo
