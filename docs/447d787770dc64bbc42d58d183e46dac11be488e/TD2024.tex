...
\item
  Tässä tapauksessa paras arvio (nk. suurimman uskottavuuden estimaatti, ks. luku \ref{luku8}) todennäköisyydelle, että satunnaisesti valittu äänestysikäinen kansalainen äänestää tiettyä puoluetta on kyseisen puolueen saama osuus kaikista kyselyyn vastanneista, kunhan otos on edustava (ks. \ref{luku5}).
\item
...
\item
  ...
  \item
    ...
    \tightlist
    \item
      Täten odotusarvo kuvaa normaalijakauman tapauksessa sen ``sijaintia''. Huomioi, että tämä on erityisesti normaalijakauman ominaisuus eikä yleispätevä sääntö.
    \end{itemize}
  \item
...
\section{Otannan haasteita vielä kootusti}\label{alaluku73}}
...
\hypertarget{luku8}{%
\chapter{Otokset ja otosjakaumat: tilastollisen päättelyn näkökulma}\label{luku8}}
...
\section{Otosjakauma: Estimaattori ja estimaatti}\label{alaluku83}}
...
\hypertarget{satunnaisuudesta-johtuvan-tulosten-epuxe4varmuuden-arvioiminen-tilastotieteessuxe4-luku9}{%
\chapter{Satunnaisuudesta johtuvan tulosten epävarmuuden arvioiminen tilastotieteessä \{luku9\}}\label{satunnaisuudesta-johtuvan-tulosten-epuxe4varmuuden-arvioiminen-tilastotieteessuxe4-luku9}}
...
\caption{t-jakauman (ja standardoidun normaalijakauman) tiheysfunktioita}\label{fig:unnamed-chunk-10}
\end{figure}
